...
BitmapString.imageMapping = "images/*.png" 													-- maps icons to a location.
...
function BitmapString:setImageLocation(location)
	BitmapString.imageMapping = location or "images/*.png"
end
...
function SampleRollOut:shakeEvent(name,info,data) 
  -- haven't bothered to implement this but it comes out on the console.
end
...
local Modifiers = { WobbleModifier = WobbleModifier,										-- create table so we can provide the Modifiers.
          ...
          RolloutModifier = RolloutModifier}

return { BitmapString = BitmapString, Modifiers = Modifiers, FontManager = BitmapString, Curve = Curve, BitmapFont = BitmapFont, SampleRollOut = SampleRollOut }
